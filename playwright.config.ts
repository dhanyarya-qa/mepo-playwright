...
export default defineConfig({
  ...
  /* Timeout per test - dinaikkan untuk menghindari flaky timeout pada server lambat */
  timeout: 60000,
  ...
  use: {
    ...
    /* Navigation timeout - dinaikkan untuk menghindari flaky timeout pada server lambat */
